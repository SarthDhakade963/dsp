...
x_values = input("Enter the x values of Signal: "); %[1, 1.5, 1, 1]
t_indices = input("Enter the y value of Signal: ");  %[-1, 0, 1, 2]
...
x_values = input("Enter the x values of Signal: "); %[1, 2, -1, 0, -2];
t_indices = input("Enter the y value of Signal: "); %[-2, -1, 0, 1, 2];
